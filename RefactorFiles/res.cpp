...
//------------------------------------------------------------------------------
/*
  проверка определенности операции  НМА K7+ #endif
*/
//---
...
//------------------------------------------------------------------------------
/*
  конструктор для использования в конструкторе процесса  конструктор, просто запоминает параметры ничего не рассчитывая, эскиз дадим потом
*/
//---
...
//------------------------------------------------------------------------------
/*
  IfCopibleOperationOnEdges и т.д.  Т.е. через MakePureSolid или через интерфейсы IfCopibleOperationOnPlaces,  Можно ли копировать эту операцию как-нибудь иначе, кроме как геометрически?
*/
//---
